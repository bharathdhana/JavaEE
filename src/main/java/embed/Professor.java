...
public class Professor {
    ...
    @Embedded
    @AttributeOverrides({
            @AttributeOverride(column = @Column(name = "final_id"),name = "subjId"),
            @AttributeOverride(column = @Column(name = "final_paper"),name="subjname"),
            @AttributeOverride(column = @Column(name = "final_year"),name = "year")
    })
    private Subject finalYear;
    @Embedded
    @AttributeOverrides({
            @AttributeOverride(column = @Column(name = "pre_final_id"),name ="subjId"),
            @AttributeOverride(column = @Column(name = "pre_final_paper"),name = "subjname"),
